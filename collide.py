...
while True:    
    ...
    if bee.bee.colliderect(pipe1.topPipe) or bee.bee.colliderect(pipe1.bottomPipe) :or bee.bee.colliderect(pipe2.topPipe)o or bee.bee.colliderect(pipe2.bottomPipe) #Modify the condition so that bee also collides with pipe2
        state="over"
